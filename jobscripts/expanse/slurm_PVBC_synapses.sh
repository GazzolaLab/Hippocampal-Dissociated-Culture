...
rm -f ${DATASET_PREFIX}/PVBC_*.h5

# Creating dendritic trees in NeuroH5 format
echo "Neurotree import"
neurotrees_import PVBC ${DATASET_PREFIX}/PVBC_tree.h5 morphology/PVBC.swc

echo "Copy tree structure into config file"
h5copy -p -s '/H5Types' -d '/H5Types' -i ${DATASET_PREFIX}/MiV_h5types.h5 -o ${DATASET_PREFIX}/PVBC_tree.h5
...
mpirun -np 64 distribute-synapse-locs \
              ...
              --output-path=${DATASET_PREFIX}/PVBC_forest.h5 \
