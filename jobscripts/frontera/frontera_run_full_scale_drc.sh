#!/bin/bash
#SBATCH -J MiV_run_full_scale_drc
...
export MAIN_CONFIG="Full_Scale_Dynamic_Response_Features.yaml"

results_path=$DATA_PREFIX/results/Full_Scale_Dynamic_Response_Features_$SLURM_JOB_ID
export results_path
