...
#SBATCH -o ./results/MiV_run_slice_100_temporal_features.%j.o
#SBATCH --nodes=10
...
export MAIN_CONFIG="Slice_100_Temporal_Features.yaml"
...
ibrun run-network \
    ...
    --spike-input-path="${DATA_PREFIX}/Slice/CA1_Slice_100_temporal_features.h5" \
